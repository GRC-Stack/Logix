...
class ReceiptsDashboardWidgetTitleRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void shareReceipts(BuildContext context, double receipts) {
      final String text =
          "Total Receipts is ${userDocument['total_receipts'].toString()}, and total number of vouchers ${userDocument['num_receipts_vouchers'].toString()}. - Shared via restat.co/Logix.in";
