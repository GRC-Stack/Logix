...
class PaymentsDashboardWidgetTitleRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void sharePayments(BuildContext context, double payments) {
      final String text =
          "Total Payments is ${userDocument['total_payments'].toString()}, and total number of vouchers ${userDocument['num_payments_vouchers'].toString()}. - Shared via restat.co/Logix.in";
